...
for TASK in ${TASKS[@]}; do
    ...
    CUDA_VISIBLE_DEVICES=0 HYDRA_FULL_ERROR=1 TORCHDYNAMO_CAPTURE_SCALAR_OUTPUTS=1 torchrun \
        scripts/run.py \
        --config-name=bridge \
        ...
        name=bridge_beta \
        'checkpoint_path="/cephfs/cjyao/code/3dpi0/log/train/bridge2_processed_pi0_4_beta/2025-04-22_13-30_42/checkpoint/step10591.pt"'
done
