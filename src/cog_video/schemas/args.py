...
class Args(BaseModel):
    ...
    train_mode: Literal["video", "action"] = "video"
    ...
    ########## Data ###########
    data_root: Path
    dataset_name: str = "bridge2_processed"
    caption_column: Path
    ...
    def parse_args(cls):
        ...
        parser.add_argument("--dataset_name", type=str, default="bridge2_processed")
        ...
        parser.add_argument("--action_hidden_size", type=int, default=512)
        parser.add_argument("--action_lens", type=int, default=17)
        ...
        parser.add_argument("--train_mode", type=str, default="video")
