...
from src.datasets.base_dataset import get_validation_window_size
from src.rollout.rollout_video import RolloutVideo
from src.utils.utils import get_portion_of_batch_ids
...
class Rollout(Callback):
    ...
    def on_validation_start(self, trainer: Trainer, pl_module: LightningModule) -> None:
        ...
        if self.env is None:
            ...
            from models.rollout.rollout_long_horizon import RolloutLongHorizon
