...
from .dataset_calvin import CalvinDataset
import src
from src.datasets.utils.episode_utils import load_dataset_statistics
from src.datasets.utils.shared_memory_utils import load_shm_lookup, save_shm_lookup, SharedMemoryLoader
...
class HulcDataModule(pl.LightningDataModule):
    def __init__(
        ...
        **kwargs: Dict,
        ...
        if not root_data_path.is_absolute():
            root_data_path = Path(models.__file__).parent / root_data_path
        ...
        self.use_shm = False
        self.language_data_dir = language_data_dir
    ...
    def setup(self, stage=None):
        ...
        #self.train_qa_dataset = CalvinDataset(root = self.language_data_dir, instructions_path = self.training_dir, split = 'training')
