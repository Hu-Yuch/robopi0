...
from src.model.vla.pizero3d import PiZero3DInference
...
class EvalAgent:
    def __init__(self, cfg):
        ...
        self.model = PiZero3DInference(cfg, use_ddp=False)
        print('load_from:',cfg.checkpoint_path)
    ...
    def run(self):
        ...
        while 1:
            ...
            intrinsics = dataset_intrinsics["default"]
            ...
            inputs = {
                ...
                "intrinsic": intrinsics.to(self.dtype),
            }
