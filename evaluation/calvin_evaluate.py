...
from src.model.vla.pizero3d_calvin import PiZero3DInference
...
def rollout(env, model, task_oracle, cfg, subtask, lang_embeddings, val_annotations, record=False, rollout_video=None):
    ...
    for step in range(cfg.ep_len):
        inputs = model.preprocess_batch(obs, goal, split_mask=True,
...
@hydra.main(config_path="../config/eval", config_name="calvin_bridge_3B")
def main(cfg):
    ...
    model = PiZero3DInference(cfg, use_ddp=False)
